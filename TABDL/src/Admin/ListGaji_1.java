...
@NamedQueries({
    ...
    @NamedQuery(name = "ListGaji_1.findByIdKaryawan", query = "SELECT l FROM ListGaji_1 l WHERE l.idKaryawan = :idKaryawan"),
    @NamedQuery(name = "ListGaji_1.findByIdPeriode", query = "SELECT l FROM ListGaji_1 l WHERE l.idPeriode = :idPeriode"),
