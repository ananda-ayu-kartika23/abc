...
public class PemberitahuanCuti extends javax.swing.JDialog {
    ...
    void tampilkanDataCuti() {
        ...
        try {
            ...
            for (Cuti_1 c : hasil) {
                ...
                String namaKaryawan;
                namaKaryawan = (c.getIdKaryawan() != null)
                        ? getNamaKaryawan(c.getIdKaryawan())
                        : "-";

                String namaAdmin;
                namaAdmin = (c.getIdAdmin() != null)
                        ? getNamaAdmin(c.getIdAdmin())
                        : "-";

                String namaSupervisor = (c.getSupervisor() != null)
                        ? getNamaKaryawan(c.getSupervisor())
                        : "-"; // supervisor juga Karyawan
    ...
    private String getNamaKaryawan(Integer idKaryawan) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private String getNamaAdmin(Integer idAdmin) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
